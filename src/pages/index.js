...
const projects = [
  {
    ...
    highlightsId: [
      'Multi-step Refill & Service Booking Flow (Pemesanan isi ulang & servis APAR instan)',
      'Smart APAR Expiration & Lifecycle Tracking (Monitoring masa kadaluwarsa & riwayat tabung)',
      'Integrated E-Commerce with RajaOngkir API (Katalog tabung APAR & hitung ongkir otomatis)',
      'Real-time Technician Dispatch & Task Workspace (Manajemen penugasan & log pengerjaan teknisi)',
      'Supplier Procurement & Purchase Order (PO) Engine (Sistem PO, cetak surat jalan PDF & notifikasi WA)',
      'Comprehensive Analytics & Financial PDF Export (Laporan keuangan & operasional otomatis)',
    ],
    highlightsEn: [
      'Multi-step Refill & Service Booking Flow (Instant APAR refill and service requests)',
      'Smart APAR Expiration & Lifecycle Tracking (Expiration date & cylinder history monitoring)',
      'Integrated E-Commerce with RajaOngkir API (Product catalog & automated shipping calculation)',
      'Real-time Technician Dispatch & Task Workspace (Technician assignment & work log tracking)',
      'Supplier Procurement & Purchase Order (PO) Engine (PO system, PDF delivery note printing & WhatsApp alerts)',
      'Comprehensive Analytics & Financial PDF Export (Automated financial & operational report exports)',
    ],
  ...
  },
  {
    ...
    figma: 'https://www.figma.com/design/lEqspzlItLCg7SnVeSvjQ1/MOBENG?node-id=2-1315&t=Xz6cFTHB3SkCIfBo-1',
    demo: '#',
  },
]
